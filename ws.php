<?php
  ...
  function makeUnits( $sPropName )
  {
    ...
    [
      ...
      'feelsLike' => $sDegreesF,
      // 'highlow'
      'humidityHigh' => $sPercent,
      'humidityHighLocalStr' => $sNoUnits,
      'humidityHighUtcStr' => $sNoUnits,
      'humidityLow' => $sPercent,
      'humidityLowLocalStr' => $sNoUnits,
      'humidityLowUtcStr' => $sNoUnits,
      'pressureSeaLevelHigh' => $sInches,
      'pressureSeaLevelHighLocalStr' => $sNoUnits,
      'pressureSeaLevelHighUtcStr' => $sNoUnits,
      'pressureSeaLevelLow' => $sInches,
      'pressureSeaLevelLowLocalStr' => $sNoUnits,
      'pressureSeaLevelLowUtcStr' => $sNoUnits,
      'rainRateMax' => $sInches . $sPerHour,
      'rainRateMaxLocalStr' => $sNoUnits,
      'rainRateMaxUtcStr' => $sNoUnits,
      'temperatureHigh' => $sDegreesF,
      'temperatureHighLocalStr' => $sNoUnits,
      'temperatureHighUtcStr' => $sNoUnits,
      'temperatureLow' => $sDegreesF,
